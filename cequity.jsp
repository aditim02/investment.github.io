...
//                            System.out.print("riskgrade" + riskgrade + "\n");
                ...
                <div class="submit_btn">
                        <button type="" value='' class="btn btn-info"><font size="4"><a style="color:black">Amount as per 3 year returns=<%=eq%></a></button></font>
                    </div>
   <div class="submit_btn">
                                                     <button type="button" class="btn btn-outline-success"><font size="4"><a style="text-color:success;"href="cdebt.jsp">Go for debt investment </a></button></font>
                                             </div>
