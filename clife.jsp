    ...
    <body>
        ...
        <div align="center"><div class="content-box"style="background-color: lightgrey;
                ...
                <div class="form-input"><font size="4">
                    <form  action="clife.jsp" method= "post">
...
<div class="submit_btn">
                                                     <button type="button" class="btn btn-outline-success"><font size="4"><a style="text-color:success;"href="cmed.jsp">Go for health insurance </a></button></font>
                                             </div>
