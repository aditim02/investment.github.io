...
<html>
    ...
    <html lang="zxx">
        ...
        <body>
            ...
            <div align="center">
                <div class="card  border-dark mb-3" style="max-width: 1300px;height:45rem;">
                                    ...
                                    <div align="justify">        
                                        ...
                                        <div class="card-group">
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <!-- Card image -->
                                                <div class="view overlay">
                                                    <img class="card-img-top" src="images/fmp.png" alt="Card image cap"style="height:8rem;">
                                                    <a href="#!">
                                                        <div class="mask rgba-white-slight"></div>
                                                    </a>
                                                </div>
            ...
            <div align="center"><div class="content-box"style="background-color: lightgrey;
                    ...
                    <div class="card-text">
                        ...
                        </table></font></br> <div class="submit_btn">
                        ...
                        <!--  <font size="4"><table class="table table-bordered table-striped"align="center"style="width:40rem;">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">Investing Amount</th>       
                        ...
                        <!--Info--><div align="center">
                            ...
                            <div class="card  border-dark mb-3" style="max-width: 1300px;height:55rem;">
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                        ...
                        <div align="center"><div class="content-box"style="background-color: lightgrey;
                                ...
                                <div class="card-text"><div class="form-input "><font size="4">
                                    ...
                                    </table></font> <div class="submit_btn">
                    ...
                    <br><br></br></br></div></div>
                                    ...
                                    <div align="center">
                                        <div class="card  border-dark mb-3" style="max-width: 1300px;height:40rem;">
                                            <div class="row no-gutters">
                                                <div class="col-md-4">
   ...
   <div class="submit_btn">
                                                     <button type="button" class="btn btn-outline-success"><font size="4"><a style="text-color:success;"href="lifemod1.jsp">Go for life insurance </a></button></font>
                                             </div>
