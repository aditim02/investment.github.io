...
<html lang="eng">
    ...
    <body>
        ...
        <div align="center">
            <div class="card  border-dark mb-3" style="max-width: 1500px;height:170rem;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="images/licc.png" style="height:170rem;"class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body text-dark">
                                ...
                                <div class="card-group">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="view overlay">
                                            <img class="card-img-top" src="images/term1.jpg" alt="Card image cap"style="height:18rem;">
                                            <a href="#!">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <!-- Card image -->
                                        <div class="view overlay">
                                            <img class="card-img-top" src="images/end1.png" alt="Card image cap"style="height:18rem;">
                                            <a href="#!">
                                                <div class="mask rgba-white-slight"></div>
                                            </a>
                                        </div>
                            ...
                            <div class="card-group">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <!-- Card image -->
                                    <div class="view overlay">
                                        <img class="card-img-top" src="images/whole1.png" alt="Card image cap"style="height:18rem;">
                                        <a href="#!">
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <!-- Card image -->
                                    <div class="view overlay">
                                        <img class="card-img-top" src="images/money1.jpg" alt="Card image cap"style="height:18rem;">
                                        <a href="#!">
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
        ...
        <div align="center"><div class="content-box"align="center"style="background-color: lightgrey;
                                 width: 80rem;
                                 border: 15px solid green;
                                 padding: 30px;
                                 margin: 20px;">
                <h3 class="card-title">Let's Calculate!!!</h3></br>
                <form action="life.jsp", method="post">
                  <select class="form-dropdown btn btn-success" style="margin-right: 4rem; " name="policy" required>
                    ...
                    <input type="text" style="margin-right: 4rem;"size="10" name="age" placeholder="" required>
                    </br></br>

                    <label class="form-label"> Sum Assured <span class="form-required">  </span></label>

                    <input type="text" style="margin-right: 4rem;"size="10" name="sumassured" placeholder="" required>
                    </br></br>
                    ...
                    <a class="btn text-uppercase btn-info" href="policy.jsp">Learn More About Policies</a>
