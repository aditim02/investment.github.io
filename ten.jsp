        ...
        <div class="contact py-5">
            ...
            <div align="center">
                ...
                <font size="4"><table class="table table-bordered table-striped"align="center"style="width:55rem;">
                    ...
                    <div class="submit_btn">
                        <button type="" value='' class="btn btn-info"><font size="4"><a style="color:black">Amount as per 3 year return of the above scheme(last)=<%=ten%></a></button></font>
                    </div>
